...
// Type: StatueOfColonist.StatueOfColonistDef
...
{
  public class StatueOfColonistDef : ThingDef
  {
    public float scale = 1f;
    public float offsetX;
    public float offsetZ;
    public float scaleMinified = 1f;
    public float offsetXMinified;
    public float offsetZMinified;
  }
}
